					...
					<table class="w-full text-left text-gray-500">
						...
						<tbody>
							...
							<tr
								...
								<td class="hidden p-6 text-gray-300">
									<span class="animate-pulse rounded-lg bg-gray-300"
										>authorizedby</span
									>
								</td>
								<td class="tablet:table-cell p-6 text-gray-300">
									<span class="animate-pulse rounded-lg bg-gray-300"
										>bookingstage</span
									>
								</td>
							...
							<tr
								...
								:key="index">
								<td class="generic-table-cell py-4 ps-3">
									<span class="inline-flex items-center space-x-1">
										...
										<span
											...
											MANF {{ fleet.yearOfManufacture }}</span
										>
									</span>
									<br />
									<span class="text-sm">{{ fleet.vehicleMake ?? 'N/A' }}</span>
								</td>
								<td class="generic-table-cell tablet:table-cell hidden py-4">
									<span class="text-sm">{{ fleet.chassisNumber ?? 'N/A' }}</span>
									<br />
									<span
										class="w-fit rounded-lg bg-pink-200 px-1 text-sm text-pink-600"
								...
								<td class="generic-table-cell laptop-lg:table-cell hidden py-4">
									<span>Assessed {{ fleet.asessedValue ?? 'N/A' }}</span>
									<br />
									<span class="w-fit rounded-lg bg-pink-200 px-1 text-pink-600"
										>W/Screen {{ fleet.windscreenValue ?? 'N/A' }}</span
									>
								</td>
								<td class="generic-table-cell laptop:table-cell hidden py-4">
									<span>Radio {{ fleet.radioValue ?? 'N/A' }}</span>
									<br />
									<span class="w-fit rounded-lg bg-pink-200 px-1 text-pink-600"
										>2-Way Radio{{ fleet.twoWayRadioValue ?? 'N/A' }}</span
									>
								</td>
								<td
									class="generic-table-cell tablet:table-cell hidden py-4 text-wrap">
									{{ fleet.inspectionNB ?? 'N/A' }}
								</td>
								<td class="generic-table-cell py-4 pe-3">
									<button
