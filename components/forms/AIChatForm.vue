<template>
	<form
		...
		class="tablet:flex-row tablet:space-y-0 tablet:space-x-2 tablet:justify-center flex flex-col items-center space-y-2 p-4">
		<input
			type="text"
			placeholder="Say hi or hello..."
		...
		<button
			...
			class="generic-form-submit tablet:w-1/4 mb-0 w-1/2 rounded-full bg-blue-600 whitespace-nowrap shadow-md">
			Send Request
		</button>
	</form>
</template>
