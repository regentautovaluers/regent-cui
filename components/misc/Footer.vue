			...
			<div>
				...
				<div class="mt-8 flex items-center space-x-6">
					...
					<a
						...
						class="hover:text-slate-103 inline-flex size-14 items-center justify-center rounded-full bg-slate-100 p-3 text-gray-500 transition-all duration-100 ease-linear hover:bg-blue-600 hover:text-slate-100">
						<svg
