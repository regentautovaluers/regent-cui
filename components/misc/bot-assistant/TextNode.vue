<template>
	<div class="my-3 flex items-center space-x-2">
		<button
			disabled
			class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-none text-pink-500 outline-none">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="30"
				height="30"
				viewBox="0 0 20 20"
				v-if="props.isSourceBot">
				<path
					fill="currentColor"
			...
			<img
				:src="profilePicture"
				alt="User Avatar"
				class="size-12 rounded-full outline-none"
				v-else />
		</button>
