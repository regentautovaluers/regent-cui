<template>
	<div class="my-3 flex items-center space-x-2">
		<button
			disabled
			class="inline-flex h-12 w-40 items-center justify-center rounded-full bg-none text-pink-500 outline-none">
			<svg
		...
		<p class="flex-grow rounded-lg border p-2 text-sm text-gray-500">
			{{ props.text }}
		</p>
	</div>
</template>
...
<script setup lang="ts">
	...
	const props = defineProps({
		text: {
			...
			type: String,
			default:
				'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dignissimos aperiam, velit veniam illum iure consequatur, eos fugiat dolorum beatae amet officia blanditiis molestiae a inventore voluptate? Rem voluptate exercitationem eaque.',
		},
		source: {
			required: true,
			isSourceBot: Boolean,
